<?php
	...
	$result = getAll($conn);
?>
	<p class="lead"><a href="admin_add.php">Add Product</a></p>
            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4>just put letter as keywords in your search </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM user_form WHERE CONCAT('name,email,password') LIKE '%$filtervalues%' ";
