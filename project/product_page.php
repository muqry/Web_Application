...
<head>
    ...
    <title>Perabot Hijau Kuning</title>
...
<div class="container" style="margin-top:65px">
        ...
        <div class="jumbotron text-center">
            <h1>Welcome to Perabot Hijau Kuning!</h1>
            <p>All about Jelapang Padi. Green Yellow Furniture remains in the hearts of users.Kedah Maju!!</p>
        </div>
        <!--jumbutron ends-->
        <!--breadcrumb start-->
    ...
    <hr/>
    <!--menu list-->
    <div class="row text-center" id="bed">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/perabot1.jpg" alt="" class="img-fluid pb-1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/perabot2.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Kilau Bed</h6>
                    <h6>Price :RM 2500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/Perabot3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Tuah Bed</h6>
                    <h6>Price :RM 1500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/Perabot4.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Lekir Bed</h6>
                    <h6>Price :RM 2800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
    ...
    <div class="row text-center" id="table">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/Meja1.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Wira Table</h6>
                    <h6>Price :RM 1800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/Meja2.png" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Saga Table</h6>
                    <h6>Price :RM 2000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/Meja3.png" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Waja Table</h6>
                        <h6>Price :RM 800</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/Meja4.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Satria Table</h6>
                        <h6>Price :RM 2100</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="row text-center" id="sofa" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/sofa1.png" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Shamelin Sofa</h6>
                            <h6>Price :RM 700</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/sofa2.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Jitra Sofa</h6>
                            <h6>Price :RM 3000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/sofa3.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Kelebang Sofa</h6>
                            <h6>Price :RM 1200</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/sofa4.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>Puchong Sofa</h6>
                    <h6>Price :RM 1800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="row text-center" id="closet">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/almari1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Rs Closet</h6>
                                <h6>Price :RM 2300</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/almari2.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Y15 Closet</h6>
                                <h6>Price :RM 1500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/almari3.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Raider Closet</h6>
                                <h6>Price :RM 2000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/almari4.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>X1r Closet</h6>
                                <h6>Price :RM 2100</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
